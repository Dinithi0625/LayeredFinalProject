...
public class OrdersDAOImpl implements OrdersDAO {
    ...
    public boolean saveOrderProductTable(OrderDetail DTO) throws SQLException {
...
//    }
    ...
    public String insertPayment(Payment paymentDTO) throws SQLException {
        Connection connection = DBConnection.getInstance().getConnection();
        try {
            connection.setAutoCommit(false);
    ...
    public boolean save(Order DTO) throws SQLException {
        return SqlUtil.execute("INSERT INTO orders (orderId, date, custId) VALUES (?, ?, ?)",
                DTO.getOrderId(),
                DTO.getDate(),
                DTO.getCustId()
        );
